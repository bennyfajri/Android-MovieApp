...
import com.drsync.core.data.MovieRepository
import com.drsync.core.data.local.LocalDataSource
import com.drsync.core.data.local.room.MovieDatabase
...
val networkModule = module {
    single {
        ...
        val certificatePinner = CertificatePinner.Builder()
            .add(hostname, "sha256/WAoRPvbez1Y2dfYfuo4yujAcYHXdv1Ivb2v2MOKk=")
